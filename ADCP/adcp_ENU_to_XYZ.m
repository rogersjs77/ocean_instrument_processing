% function [adcp] = adcp_ENU_to_XYZ(adcp,time_id)
% 
...
for i = 1:size(adcp.east_vel,1)
    V_temp = Minv*[adcp.east_vel(i,:);adcp.north_vel(i,:);...
        adcp.vert_vel(i,:)];
